...
function AboutPage() {
    return (
        <section className="h-full bg-sky-500 relative overflow-y-auto">
            <article className="absolute w-full h-full z-10 grid grid-cols-1 mt-20 md:mt-0 md:grid-cols-2 gap-0 md:gap-16 justify-center justify-items-center md:justify-items-stretch items-center px-10">
                <div className='flex justify-end relative group'>
                    <img className='rounded-2xl z-10 group-hover:scale-[101%] transition duration-300 transform' src={ImageDaprion} alt=""/>
