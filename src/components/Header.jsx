...
function Header() {
    return (
        <header className=" bg-gray-800 p-2 rounded-b-xl shadow-white shadow text-white grid grid-cols-1 md:grid-cols-2 items-center justify-items-center">
            <div className="">
            ...
            <div className="">
                <nav className="">
                    <ul className="flex gap-3 font-bold">
                        <NavLink to="home" className={({isActive}) => !isActive ? 'border-red-500 border-b-2' : null}>
