...
const IconTecnology = ({ name, url }) => {
    ...
    return (
        <>
            <div data-tooltip-id={idToolTip} data-tooltip-content={name} className='min-w-[100px] bg-white rounded-2xl shadow-3xl transform transition duration-300 hover:rotate-6 hover:scale-[101%]'>
